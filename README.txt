...
Built by event organizers, for event organisers.
...
= 1.0.6 - 15 March 2022=
 * Update SDK verion 2.4.3

 = 1.0.5 - 20 September 2021=
 * Update SDK verion 2.4.2

 = 1.0.3 - 27 November 2020=
 * Update SDK verion 2.4.1
 

 = 1.0.2 - 24 June 2019 =
 * Added Option to delete Sessions on each block
 * Fixed Blog2Social CSS conflict
 * Fixed Sessions not Saving
